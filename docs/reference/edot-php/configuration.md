...
| Turn off sending logs              | send_logs                       | Dynamic | {applies_to}`stack: preview 9.3` {applies_to}`edot_php: preview 1.3.0` |
| Turn off sending metrics           | send_metrics                    | Dynamic | {applies_to}`stack: preview 9.3` {applies_to}`edot_php: preview 1.3.0` |
| Turn off sending traces            | send_traces                     | Dynamic | {applies_to}`stack: preview 9.3` {applies_to}`edot_php: preview 1.3.0` |
