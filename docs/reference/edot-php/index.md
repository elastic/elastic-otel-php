...
Follow the step-by-step instructions in [Setup](/reference/edot-php/setup/index.md) to get started.

## Release notes

For the latest release notes, including known issues, deprecations, and breaking changes, refer to [EDOT PHP release notes](/release-notes/index.md)
