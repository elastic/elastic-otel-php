...
| `verify_server_cert`               | [`OTEL_EXPORTER_OTLP_INSECURE`](https://opentelemetry.io/docs/specs/otel/protocol/exporter/#configuration)                                                                                  | Enable or disable SSL verification when exporting telemetry.                                                                 |
