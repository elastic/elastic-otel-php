...
| -------------------------------------- | ------------------------------------------------------------ | ---------------------------------------------- |
| `elastic_apm.enabled = 1`              | `OTEL_PHP_ENABLED=true`                                      | Enables EDOT PHP features - enabled by default |
...
| `enabled`                          | [`OTEL_PHP_ENABLED`](/reference/edot-php/configuration.md#general-configuration)                                                                                                               | Enables or disables EDOT PHP instrumentation entirely.                                                                       |
...
| `transaction_url_groups`           | [`OTEL_PHP_TRANSACTION_URL_GROUPS`](/reference/edot-php/configuration.md#transaction-span-configuration)                                                                                       | Group similar URL paths (e.g., `/user/*`).                                                                                   |
| `inferred_spans_enabled`           | [`OTEL_PHP_INFERRED_SPANS_ENABLED`](/reference/edot-php/configuration.md#inferred-spans-configuration)                                                                                             | Enables inferred spans (preview).                                                                                            |
