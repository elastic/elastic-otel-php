...
use Elastic\OTel\Log\Level as LogLevel;
use Elastic\OTel\Log\LoggableInterface;
use Elastic\OTel\Log\LoggableTrait;
use Elastic\OTel\Log\LoggerFactory;
...
final class Snapshot implements LoggableInterface
{
    ...
    //
    //      1) Follow the steps in <repo root>/prod/native/ext/ConfigManager.h to add the new option for C part of the agent.
    ...
    //
    //         to class \ElasticOTel\Config\OptionNames
    //
    //
    //      3) Add
    //
    ...
    //
    //         to class \ElasticOTel\Config\AllOptionsMetadata
    //
    //
    //      4) Add
    //
    ...
    //              private $myNewOption;
    //
    //         to class \ElasticOTel\Config\Snapshot
    //
    //
    //      5) Add
    //
