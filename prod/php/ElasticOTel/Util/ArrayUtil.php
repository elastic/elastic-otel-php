...
final class ArrayUtil
{
     ...
     * @phpstan-param-out TValue          $valueDst
     * @phpstan-assert-if-true TValue     $valueDst
     */
    public static function getValueIfKeyExists(string|int $key, array $array, mixed &$valueDst): bool
    {
