...
use Elastic\OTel\Config\DevInternalSubOptionNames;
use Elastic\OTel\Config\OptionNames;
use Elastic\OTel\Config\Snapshot as ConfigSnapshot;
use Elastic\OTel\Log\LogCategory;
use Elastic\OTel\Log\Logger;
use Elastic\OTel\Util\ArrayUtil;
use Elastic\OTel\Util\DbgUtil;
use Elastic\OTel\Util\TextUtil;
use Elastic\OTel\Util\TimeUtil;
use Elastic\OTel\Util\UrlParts;
use Elastic\OTel\Util\UrlUtil;
...
final class TransactionForExtensionRequest
{
    ...
    public function __construct(float $requestInitStartTime)
    {
        $this->tracer = $tracer;
