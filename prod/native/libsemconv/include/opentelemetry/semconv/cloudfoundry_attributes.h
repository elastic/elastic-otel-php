 ...
 */
static constexpr const char *kCloudfoundryAppId
 = "cloudfoundry.app.id";

/**
 * The index of the application instance. 0 when just one instance is active.
 * <p>
 * CloudFoundry defines the @code instance_id @endcode in the <a href="https://github.com/cloudfoundry/loggregator-api#v2-envelope">Loggregator v2 envelope</a>.
 ...
 */
static constexpr const char *kCloudfoundryAppInstanceId
 ...
 */
static constexpr const char *kCloudfoundryAppName
 ...
 */
static constexpr const char *kCloudfoundryOrgId
 = "cloudfoundry.org.id";
 ...
 */
static constexpr const char *kCloudfoundryOrgName
 ...
 */
static constexpr const char *kCloudfoundryProcessId
 ...
 */
static constexpr const char *kCloudfoundryProcessType
 ...
 */
static constexpr const char *kCloudfoundrySpaceId
 ...
 */
static constexpr const char *kCloudfoundrySpaceName
 = "cloudfoundry.space.name";

/**
 * A guid or another name describing the event source.
 * <p>
 * CloudFoundry defines the @code source_id @endcode in the <a href="https://github.com/cloudfoundry/loggregator-api#v2-envelope">Loggregator v2 envelope</a>.
 * It is used for logs and metrics emitted by CloudFoundry. It is
 ...
 */
static constexpr const char *kCloudfoundrySystemId
 ...
 */
static constexpr const char *kCloudfoundrySystemInstanceId
