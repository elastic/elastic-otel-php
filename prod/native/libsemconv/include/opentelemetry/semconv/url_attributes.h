 ...
 * <p>
 * For network calls, URL usually has @code scheme://host[:port][path][?query][#fragment] @endcode format, where the fragment
 * is not transmitted over HTTP, but if it is known, it SHOULD be included nevertheless.
 * <p>
 * @code url.full @endcode MUST NOT contain credentials passed via URL in form of @code https://username:password@www.example.com/ @endcode.
 * In such case username and password SHOULD be redacted and attribute's value SHOULD be @code https://REDACTED:REDACTED@www.example.com/ @endcode.
 * <p>
 ...
 * <ul>
 *   <li><a href="https://docs.aws.amazon.com/AmazonS3/latest/userguide/RESTAuthentication.html#RESTAuthenticationQueryStringAuth">@code AWSAccessKeyId @endcode</a></li>
 ...
 */
static constexpr const char *kUrlFull
 = "url.full";
 ...
 */
static constexpr const char *kUrlQuery
 = "url.query";
