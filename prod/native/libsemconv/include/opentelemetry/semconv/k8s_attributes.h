...
/**
 * The annotation key-value pairs placed on the Pod, the @code <key> @endcode being the annotation name, the value being the annotation value.
 */
static constexpr const char *kK8sPodAnnotation
 = "k8s.pod.annotation";

/**
 * The label key-value pairs placed on the Pod, the @code <key> @endcode being the label name, the value being the label value.
 */
