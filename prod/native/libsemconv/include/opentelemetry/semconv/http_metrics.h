 ...
 * updowncounter
 */
static constexpr const char *kMetricHttpClientActiveRequests
 = "http.client.active_requests";
static constexpr const char *descrMetricHttpClientActiveRequests
 = "Number of active HTTP requests.";
static constexpr const char *unitMetricHttpClientActiveRequests
 = "{request}";

static inline nostd::unique_ptr<metrics::UpDownCounter<int64_t>
>
CreateSyncInt64MetricHttpClientActiveRequests
(metrics::Meter *meter)
{
  return meter->CreateInt64UpDownCounter
(
    kMetricHttpClientActiveRequests
,
...
>
CreateSyncDoubleMetricHttpClientActiveRequests
(metrics::Meter *meter)
{
...
>
CreateAsyncInt64MetricHttpClientActiveRequests
(metrics::Meter *meter)
{
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricHttpClientActiveRequests
(metrics::Meter *meter)
{
...
static constexpr const char *descrMetricHttpClientConnectionDuration
 = "The duration of the successfully established outbound HTTP connections.";
static constexpr const char *unitMetricHttpClientConnectionDuration
 = "s";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpClientConnectionDuration
(metrics::Meter *meter)
{
...
>
CreateSyncDoubleMetricHttpClientConnectionDuration
(metrics::Meter *meter)
{
...
static constexpr const char *descrMetricHttpClientOpenConnections
 = "Number of outbound HTTP connections that are currently active or idle on the client.";
static constexpr const char *unitMetricHttpClientOpenConnections
 = "{connection}";

static inline nostd::unique_ptr<metrics::UpDownCounter<int64_t>
>
CreateSyncInt64MetricHttpClientOpenConnections
(metrics::Meter *meter)
{
  return meter->CreateInt64UpDownCounter
(
    kMetricHttpClientOpenConnections
,
...
static inline nostd::unique_ptr<metrics::UpDownCounter<double>
>
CreateSyncDoubleMetricHttpClientOpenConnections
(metrics::Meter *meter)
{
  return meter->CreateDoubleUpDownCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricHttpClientOpenConnections
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableUpDownCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricHttpClientOpenConnections
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableUpDownCounter
(
...
static constexpr const char *descrMetricHttpClientRequestBodySize
 = "Size of HTTP client request bodies.";
static constexpr const char *unitMetricHttpClientRequestBodySize
 = "By";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpClientRequestBodySize
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricHttpClientRequestBodySize
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpClientRequestBodySize
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static constexpr const char *descrMetricHttpClientRequestDuration
 = "Duration of HTTP client requests.";
static constexpr const char *unitMetricHttpClientRequestDuration
 = "s";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpClientRequestDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricHttpClientRequestDuration
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpClientRequestDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static constexpr const char *descrMetricHttpClientResponseBodySize
 = "Size of HTTP client response bodies.";
static constexpr const char *unitMetricHttpClientResponseBodySize
 = "By";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpClientResponseBodySize
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpClientResponseBodySize
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
 ...
 * updowncounter
 */
static constexpr const char *kMetricHttpServerActiveRequests
 = "http.server.active_requests";
static constexpr const char *descrMetricHttpServerActiveRequests
 = "Number of active HTTP server requests.";
static constexpr const char *unitMetricHttpServerActiveRequests
 = "{request}";

static inline nostd::unique_ptr<metrics::UpDownCounter<int64_t>
>
CreateSyncInt64MetricHttpServerActiveRequests
(metrics::Meter *meter)
{
  return meter->CreateInt64UpDownCounter
(
...
static inline nostd::unique_ptr<metrics::UpDownCounter<double>
>
CreateSyncDoubleMetricHttpServerActiveRequests
(metrics::Meter *meter)
{
  return meter->CreateDoubleUpDownCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncInt64MetricHttpServerActiveRequests
(metrics::Meter *meter)
{
  return meter->CreateInt64ObservableUpDownCounter
(
...
static inline nostd::shared_ptr<metrics::ObservableInstrument
>
CreateAsyncDoubleMetricHttpServerActiveRequests
(metrics::Meter *meter)
{
  return meter->CreateDoubleObservableUpDownCounter
(
...
static constexpr const char *descrMetricHttpServerRequestBodySize
 = "Size of HTTP server request bodies.";
static constexpr const char *unitMetricHttpServerRequestBodySize
 = "By";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpServerRequestBodySize
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricHttpServerRequestBodySize
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpServerRequestBodySize
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static constexpr const char *descrMetricHttpServerRequestDuration
 = "Duration of HTTP server requests.";
static constexpr const char *unitMetricHttpServerRequestDuration
 = "s";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpServerRequestDuration
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricHttpServerRequestDuration
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpServerRequestDuration
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
...
static constexpr const char *descrMetricHttpServerResponseBodySize
 = "Size of HTTP server response bodies.";
static constexpr const char *unitMetricHttpServerResponseBodySize
 = "By";

static inline nostd::unique_ptr<metrics::Histogram<uint64_t>
>
CreateSyncInt64MetricHttpServerResponseBodySize
(metrics::Meter *meter)
{
  return meter->CreateUInt64Histogram
(
    kMetricHttpServerResponseBodySize
,
...
static inline nostd::unique_ptr<metrics::Histogram<double>
>
CreateSyncDoubleMetricHttpServerResponseBodySize
(metrics::Meter *meter)
{
  return meter->CreateDoubleHistogram
(
