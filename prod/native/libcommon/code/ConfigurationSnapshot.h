...
#define ELASTIC_OTEL_LOG_FILE log_file
#define ELASTIC_OTEL_LOG_LEVEL log_level
#define ELASTIC_OTEL_LOG_LEVEL_FILE log_level_file
...
#define ELASTIC_OTEL_ASYNC_TRANSPORT_SHUTDOWN_TIMEOUT async_transport_shutdown_timeout

#define ELASTIC_OTEL_DEBUG_INSTRUMENT_ALL debug_instrument_all
#define ELASTIC_OTEL_DEBUG_PHP_HOOKS_ENABLED debug_php_hooks_enabled

#define ELASTIC_OTEL_INFERRED_SPANS_ENABLED inferred_spans_enabled
#define ELASTIC_OTEL_INFERRED_SPANS_REDUCTION_ENABLED inferred_spans_reduction_enabled
#define ELASTIC_OTEL_INFERRED_SPANS_STACKTRACE_ENABLED inferred_spans_stacktrace_enabled
#define ELASTIC_OTEL_INFERRED_SPANS_SAMPLING_INTERVAL inferred_spans_sampling_interval
#define ELASTIC_OTEL_INFERRED_SPANS_MIN_DURATION inferred_spans_min_duration

#define ELASTIC_OTEL_DEPENDENCY_AUTOLOADER_GUARD_ENABLED dependency_autoloader_guard_enabled
...
#define ELASTIC_OTEL_OPAMP_HEARTBEAT_INTERVAL opamp_heartbeat_interval
#define ELASTIC_OTEL_OPAMP_SEND_TIMEOUT opamp_send_timeout
...
struct ConfigurationSnapshot {
    ...
    LogLevel ELASTIC_OTEL_LOG_LEVEL = LogLevel::logLevel_off;
    LogLevel ELASTIC_OTEL_LOG_LEVEL_FILE = LogLevel::logLevel_off;
    LogLevel ELASTIC_OTEL_LOG_LEVEL_STDERR = LogLevel::logLevel_off;
    ...
    bool ELASTIC_OTEL_DEBUG_INSTRUMENT_ALL = false;
    bool ELASTIC_OTEL_DEBUG_PHP_HOOKS_ENABLED = false;

    bool ELASTIC_OTEL_INFERRED_SPANS_ENABLED = false;
    bool ELASTIC_OTEL_INFERRED_SPANS_REDUCTION_ENABLED = true;
    bool ELASTIC_OTEL_INFERRED_SPANS_STACKTRACE_ENABLED = true;
    std::chrono::milliseconds ELASTIC_OTEL_INFERRED_SPANS_SAMPLING_INTERVAL = std::chrono::milliseconds(50);
    std::chrono::milliseconds ELASTIC_OTEL_INFERRED_SPANS_MIN_DURATION = std::chrono::milliseconds(0);
