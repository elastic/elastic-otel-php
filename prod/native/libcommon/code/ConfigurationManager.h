...
#define BUILD_METADATA(optname, type, secret)                      \
    ...
    std::map<std::string, OptionMetadata> options_ = {
        BUILD_METADATA(ELASTIC_OTEL_BOOTSTRAP_PHP_PART_FILE, OptionMetadata::type::string, false),
        BUILD_METADATA(ELASTIC_OTEL_ENABLED, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_FILE, OptionMetadata::type::string, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_LEVEL, OptionMetadata::type::loglevel, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_LEVEL_FILE, OptionMetadata::type::loglevel, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_LEVEL_STDERR, OptionMetadata::type::loglevel, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_LEVEL_SYSLOG, OptionMetadata::type::loglevel, false),
        BUILD_METADATA(ELASTIC_OTEL_LOG_FEATURES, OptionMetadata::type::string, false),
        BUILD_METADATA(ELASTIC_OTEL_DEBUG_DIAGNOSTICS_FILE, OptionMetadata::type::string, false),
        BUILD_METADATA(ELASTIC_OTEL_VERIFY_SERVER_CERT, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_MAX_SEND_QUEUE_SIZE, OptionMetadata::type::bytes, false),
        BUILD_METADATA(ELASTIC_OTEL_ASYNC_TRANSPORT, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_ASYNC_TRANSPORT_SHUTDOWN_TIMEOUT, OptionMetadata::type::duration, false),
        BUILD_METADATA(ELASTIC_OTEL_DEBUG_INSTRUMENT_ALL, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_DEBUG_PHP_HOOKS_ENABLED, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_INFERRED_SPANS_ENABLED, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_INFERRED_SPANS_REDUCTION_ENABLED, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_INFERRED_SPANS_STACKTRACE_ENABLED, OptionMetadata::type::boolean, false),
        BUILD_METADATA(ELASTIC_OTEL_INFERRED_SPANS_SAMPLING_INTERVAL, OptionMetadata::type::duration, false),
        ...
        BUILD_METADATA(ELASTIC_OTEL_OPAMP_SEND_TIMEOUT, OptionMetadata::type::duration, false),
        BUILD_METADATA(ELASTIC_OTEL_OPAMP_SEND_MAX_RETRIES, OptionMetadata::type::bytes, false),
        BUILD_METADATA(ELASTIC_OTEL_OPAMP_SEND_RETRY_DELAY, OptionMetadata::type::duration, false)
