...
BOOTSTRAP_FILE_PATH="${PHP_AGENT_DIR}/php/bootstrap_elastic.php"
...
function manual_extension_agent_setup() {
   echo 'Set up Elastic Distribution for OpenTelemetry PHP manually by adding the following to your php.ini file:'
     if [ -e "${EXTENSION_FILE_PATH}" ] ; then
        ...
        echo "opentelemetry_distro.bootstrap_php_part_file=/path/to/bootstrap_elastic.php"
    fi
}
